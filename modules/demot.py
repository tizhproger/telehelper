...
class DemotivatorMod:
    ...
    async def mqcmd(self, message):
        ...
        if not reply or not reply.raw_text:
            return await message.edit("<b>Reply to message!</b>", parse_mode='html')
        ...
        await message.edit("<b>Demotivating...</b>", parse_mode='html')
        if not pfp:
...
async def cmds(message, type_):
    ...
    if not event:
        if message.client._conversations.get(1376531590) is not None:
            return await message.edit("<b>Please wait.</b>", parse_mode='html')
        ...
        if (
            ...
            return await message.edit("<b>Reply to photo/video/sticker</b>", parse_mode='html')
        if reply.file.size > 4194304:
            return await message.edit("<b>Video only up to 4mb</b>", parse_mode='html')
        args = utils.get_args_raw(message) or reply.message
        if not args:
            return await message.edit("<b>No text</b>", parse_mode='html')
        if len(args) > 500:
            return await message.edit("<b>Text only up to 500 symbols</b>", parse_mode='html')
            ...
            try:
                ...
                if not response.media:
                    if response.raw_text.startswith("[400]"):
                        return await message.edit("<b>Please wait 10 sec</b>", parse_mode='html')
                    response = await conv.wait_event(
                        NewMessage(incoming=True, from_users=CHAT)
                    )

            except YouBlockedUserError:
                return await message.edit(f"<b>Unblock {CHAT}</b>", parse_mode='html')

            except (TimeoutError, CancelledError):
                return await message.edit("<b>Bot isn`t responding</b>", parse_mode='html')

            if response.media is None:
                return await message.edit("<b>Error</b>", parse_mode='html')
    ...
    if not text:
        await message.edit("<b>Reply to photo with text</b>", parse_mode='html')
        return
...
async def cmdrands(message, type_):
    ...
    if not event:
        ...
        reply = await message.get_reply_message()
        if not reply:
            await message.edit("<b>Reply to media</b>", parse_mode='html')
            return
        try:
            media = reply.media
        except Exception:
            return await message.edit("<b>Only media</b>", parse_mode='html')
        ...
        async with message.client.conversation(chat) as conv:
            try:
                ...
                await message.reply("<b>Разблокируй @super_rjaka_demotivator_bot</b>", parse_mode='html')
                return
            await message.edit("<b>Sending...</b>", parse_mode='html')
            await message.delete()
