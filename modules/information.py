...
class WhoIsMod:
    ...
    async def userinfocmd(self, message):
        ...
        await message.edit("<b>Getting info...</b>", parse_mode='html')
    ...
    async def chatinfocmd(self, message):
        ...
        try:
            ...
            if not message.is_private:
                ...
                return await message.edit("<b>It is not a chat!</b>", parse_mode='html')

        chat = await message.client(GetFullChannelRequest(chat.id))

        await message.edit("<b>Loading info...</b>", parse_mode='html')
